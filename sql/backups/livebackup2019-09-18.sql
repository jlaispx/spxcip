...
) ENGINE=InnoDB AUTO_INCREMENT=47 DEFAULT CHARSET=utf8 COMMENT='common list of providers - maintainable by admin';

-- Dumping data for table cip_db.cip_provider: ~40 rows (approximately)
DELETE FROM `cip_provider`;
...
INSERT INTO `cip_provider` (`providerId`, `providerName`, `location`) VALUES
	...
	(19, 'Red Dirt Expedition Immersion', 'St Pius X'),
	(20, 'To Be Confirmed', 'TBC'),
	(21, 'Centacare Industries', 'St Pius X'),
	...
	(30, 'Lifeline Shop', 'Naremburn / Waitara'),
	(31, 'Willoughby Council - Vacation Childcare', ''),
	(32, 'Red Shield Appeal', ''),
	(33, 'Food Bank NSW', 'Glendinning'),
	(34, '', ''),
	(35, 'St Vincent De Paul', 'West Ryde'),
	(36, 'Helping Elderly Neighbour', ''),
	(37, 'Brickpit Basketball Centre', 'Thornleigh'),
	(38, 'Hornsby Rugby Club', 'Waitara'),
	(39, 'SAN Fun Run', 'Wahroonga'),
	(40, 'Legacy Pin Distribution', 'St Pius X'),
	(41, 'Centacare Fun Run', ''),
	(42, 'Triva Night Setup', 'St Pius X'),
	(43, 'Electives Information Evening', 'St Pius X'),
	(44, 'West Pymble Football Club', 'West Pymble'),
	(45, 'Lindfield/Killara Parish', ''),
	(46, 'Teacher Appreciation Breakfast', 'St Pius X');
...
DELETE FROM `pastoraladjectives`;
...
-- Dumping data for table cip_db.studentimport: ~160 rows (approximately)
DELETE FROM `studentimport`;
...
) ENGINE=InnoDB AUTO_INCREMENT=111 DEFAULT CHARSET=utf8 COMMENT='Student Hours';

-- Dumping data for table cip_db.studentyearprovider: ~83 rows (approximately)
DELETE FROM `studentyearprovider`;
...
INSERT INTO `studentyearprovider` (`studentYearProviderId`, `providerId`, `yearstudentId`, `cipHours`, `venueFormFlag`, `logBookFlag`, `comments`) VALUES
	(11, 12, 3, 14, 1, 0, ''),
	(12, 17, 4, 20, 1, 1, 'Doing more on Sunday'),
	(13, 3, 6, 7, 1, 1, 'Through school'),
	(14, 13, 7, 36, 1, 1, NULL),
	(15, 1, 9, 18, 1, 1, ''),
	(16, 1, 12, 25, 1, 1, ''),
	(17, 15, 14, 5, 1, 1, ''),
	...
	(20, 15, 19, 5, 1, 1, ''),
	(21, 18, 19, 12, 1, 1, ''),
	(22, 19, 20, 20, 1, 1, 'Completed more than necessary'),
	(25, 14, 25, 23, 1, 1, ''),
	(28, 15, 33, 2, 0, 1, ''),
	(29, 21, 33, 18, 0, 1, ''),
	(30, 22, 31, 19, 1, 1, '18.5'),
	(31, 23, 5, 7, 1, 0, 'Still has not started 23/6 (for next year)'),
	(32, 14, 11, 18, 0, 1, 'TBC'),
	(33, 16, 15, 8, 1, 1, ''),
	(34, 3, 15, 9, 1, 1, ''),
	(35, 2, 15, 3, 1, 1, '1.5hrs'),
	(36, 26, 16, 4, 0, 1, ''),
	(37, 16, 16, 5, 0, 1, ''),
	(38, 15, 16, 5, 0, 1, ''),
	(39, 16, 10, 12, 1, 1, '?'),
	...
	(42, 15, 8, 4, 1, 1, ''),
	(43, 15, 23, 5, 1, 1, ''),
	(44, 16, 23, 12, 1, 1, 'Twilight Setup / Photos'),
	(45, 27, 23, 2, 1, 1, ''),
	(46, 15, 22, 4, 1, 0, 'Not signed off'),
	(47, 3, 22, 3, 1, 1, ''),
	(49, 27, 22, 4, 1, 1, ''),
	(50, 15, 26, 4, 1, 1, ''),
	(52, 28, 26, 16, 1, 1, 'Support U14 Head Coach'),
	(54, 19, 18, 20, 1, 1, 'Completed more than necessary'),
	(55, 16, 21, 16, 1, 1, ''),
	(56, 4, 24, 36, 1, 1, 'Independent - not through school - 2hrs a week'),
	(59, 16, 28, 15, 0, 0, ''),
	(61, 16, 29, 3, 1, 1, ''),
	(62, 15, 30, 5, 1, 1, ''),
	(64, 30, 32, 21, 1, 1, ''),
	...
	(68, 15, 31, 5, 1, 1, ''),
	(69, 33, 6, 11, 1, 1, ''),
	(70, 2, 3, 10, 1, 1, 'Starts in Term2 hols'),
	(71, 16, 31, 2, 1, 1, ''),
	(72, 19, 5, 20, 0, 1, 'exceeds requirements'),
	(73, 26, 11, 2, 0, 1, ''),
	(74, 16, 17, 6, 0, 1, '5.5 hrs'),
	(75, 19, 34, 20, 1, 1, ''),
	(76, 26, 27, 20, 1, 1, ''),
	(77, 35, 29, 17, 1, 1, ''),
	(78, 16, 19, 4, 1, 1, ''),
	(81, 36, 33, 4, 0, 0, ''),
	(83, 14, 13, 9, 1, 0, 'Venue form given but had hours signed for on it....need to transfer to Log Book.  he took it back'),
	(84, 37, 10, 3, 1, 1, ''),
	(85, 38, 10, 1, 1, 1, ''),
	(86, 39, 8, 6, 1, 1, ''),
	(88, 41, 8, 3, 1, 0, '(To be added: 3 hrs for Fun Run on 15 Sept)'),
	(89, 32, 6, 2, 1, 0, ''),
	(90, 40, 28, 3, 0, 0, '5 hrs anticipated'),
	(91, 40, 16, 6, 0, 1, 'Anticipate 5 hrs'),
	(92, 42, 16, 1, 0, 1, 'Anticipate 2 hrs'),
	(93, 3, 21, 3, 1, 1, ''),
	(94, 42, 21, 1, 1, 1, ''),
	(95, 39, 22, 6, 1, 1, ''),
	(96, 42, 22, 1, 1, 1, ''),
	...
	(102, 40, 30, 6, 1, 1, ''),
	(103, 26, 30, 1, 1, 0, ''),
	(104, 32, 32, 3, 1, 1, 'East Lindfield'),
	(105, 15, 32, 5, 1, 1, '4 hrs 50 mins'),
	(106, 42, 32, 4, 1, 1, ''),
	(107, 46, 32, 1, 1, 1, ''),
	(108, 45, 32, 8, 1, 1, ''),
	(109, 3, 30, 3, 1, 1, ''),
