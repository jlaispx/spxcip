...
) ENGINE=InnoDB AUTO_INCREMENT=37 DEFAULT CHARSET=utf8 COMMENT='Activities and awards students receive for this Homeroom this year.';

-- Dumping data for table cip_db.achievements: ~35 rows (approximately)
...
) ENGINE=InnoDB AUTO_INCREMENT=31 DEFAULT CHARSET=utf8 COMMENT='common list of providers - maintainable by admin';

-- Dumping data for table cip_db.cip_provider: ~24 rows (approximately)
...
) ENGINE=InnoDB AUTO_INCREMENT=65 DEFAULT CHARSET=utf8 COMMENT='Student Hours';

-- Dumping data for table cip_db.studentyearprovider: ~50 rows (approximately)
...
INSERT INTO `studentyearprovider` (`studentYearProviderId`, `providerId`, `yearstudentId`, `cipHours`, `venueFormFlag`, `logBookFlag`, `comments`) VALUES
	...
	(57, 29, 34, 0, 0, 0, ''),
	(58, 20, 27, 0, 0, 0, 'Willoughby Council - Vacation Childcare'),
	(59, 16, 28, 3, 0, 0, ''),
	(60, 26, 28, 0, 0, 0, ''),
	(61, 16, 29, 3, 0, 0, ''),
	(62, 15, 30, 5, 0, 0, ''),
